...
const childrenData: Child[] = [
  ...
  { id: "3",  name: "Gelilah H",  image: require("../assets/images/gelilah.png"), attendance: "expected" },
  { id: "4",  name: "Konrad S",       image: require("../assets/images/konrad.jpg"), attendance: "picked_up" },
  { id: "5",  name: "Sigurd J",        image: require("../assets/images/sigurd.png"), attendance: "absent" },
  { id: "6",  name: "Dina F",            image: require("../assets/images/dina.png"), attendance: "expected" },
